...
* Setting the value at a particular position in a list that has a preexisting element for that position. An error
...
----
* Removing an element by its position in the list that has a preexisting element for that position. An error
